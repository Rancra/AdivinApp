...
public class AdivinApp extends Application {
	...
	private void onsaludarButtonAction(ActionEvent evento) {
		...
		if (Integer.parseInt(nombreText.getText()) == numeroRandom) {
			...
			alert.setContentText("Solo has necesitado "+contador+" intentos. Vuelve a jugar y hazlo mejor.");
			...
			alert.setContentText("El número a adivinar es "+mayoromenor+" que "+numeroIntroducido+". Vuelve a intentarlo.");
